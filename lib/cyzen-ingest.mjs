...
export async function ingestReports({ days = 31 } = {}) {
  ...
  for (const r of reports) {
    ...
    else if (name.includes('アポ獲得')) { d.apo++; const h = hourOf(pick(r, 'report_datetime', 'reported_at', 'created_at')); if (h != null) (d.apoAt || (d.apoAt = [])).push(h); }
