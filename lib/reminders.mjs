...
function friendly(name, count) {
  const variants = [
    `${name}さん、おつかれさまです。今日の訪問件数がまだ入っていません。件数だけで大丈夫なので、入れておいてください。`,
    `${name}さん、今日ぶんの入力がまだ見当たりません。30秒で終わります。`,
    `${name}さん、まだ入力が届いていません。動いた分は残しておきましょう。`,
    `${name}さん、今日ぶんの報告をお願いします。訪問件数だけで構いません。`,
  ];
...
export async function resolveLineIds(names) {
